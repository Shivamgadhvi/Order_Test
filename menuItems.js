...
// If "image" is left blank, the app falls back to a category icon automatically.
...
export const categories = [
  ...
  },
  {
    ...
    icon: 'cookie',
    items: [
      { id: 'viral-cookies-tin', name: 'Viral Cookies Tin', tagline: 'Cookies abhi baaki hai mere dost', price: 199, image: '', iceCream: false },
    ],
  },
  {
    id: 'bites',
